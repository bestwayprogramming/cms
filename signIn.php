...
<body>
    <!-- Sign In Page -->
    <section class="vh-100 d-flex" style="background: linear-gradient(-450deg, black, transparent);">
        <div class="col-3 m-auto">
            <div class="card rounded-pill">
                <div class="card-body shadow-lg p-5 mb-0 bg-black rounded-pill">
                    <h3 class="my-3 mx-3 text-info">Sign In to continue</h3>
