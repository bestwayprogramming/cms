...
<body style="background: linear-gradient(-600deg, black, transparent);">
  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg bg-light" style="background: linear-gradient(600deg, black, transparent);">
    <div class="container-fluid ">
      <a href="index.php" class="navbar-brand">
        <img id="college-logo" src="images/logo1.png" height="50px" width="50px" alt="College Logo" draggable="false" height="30" />
